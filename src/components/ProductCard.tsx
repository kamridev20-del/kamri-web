...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <>
      ...
      <div className="p-3">
        <div className="mb-1">
          <span className="text-[9px] text-[#9CA3AF] font-normal">{product.brand || product.supplier?.name || 'CJ Dropshipping'}</span>
        </div>
        ...
        <div className="flex flex-wrap gap-0.5 mb-1.5">
          ...
          {product.listedNum && product.listedNum > 100 && (
            <span className="inline-flex items-center px-1 py-0.5 rounded-full text-[9px] font-semibold bg-[#E3F2FD] text-[#1976D2]">
              <svg className="w-2 h-2 mr-0.5" fill="currentColor" viewBox="0 0 20 20">
